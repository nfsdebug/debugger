...
NCURSES_EXPORT(int) attrset (int z)
{
	...
	returnIntAttr((attr_t)((0 != (const void *)((_nc_stdscr()))) ? ((_nc_stdscr())->_attrs = (attr_t)((z)), (0)) : (-1)));
}
NCURSES_EXPORT(int) attr_get (attr_t * a1, short * a2, void * z GCC_UNUSED)
{
	...
	returnCode(((0 != (const void *)((_nc_stdscr()))) ? ((void)((0 != (const void *)(((a1)))) ? (*((a1)) = (_nc_stdscr())->_attrs) : (0)), (void)((0 != (const void *)(((a2)))) ? (*((a2)) = (short) ((int)((((unsigned long)(((_nc_stdscr())->_attrs)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) >> 8)))) : (0)), (0)) : (-1)));
}
...
NCURSES_EXPORT(int) attr_set (attr_t a1, short a2, void * z GCC_UNUSED)
{
	...
	returnCode(((0 != (const void *)((_nc_stdscr()))) ? ((void)((_nc_stdscr())->_attrs = ((((a1)) & ~((chtype)((((1U) << 8) - 1U)) << ((0) + 8))) | (attr_t)(((chtype)((((a2)))) << ((0) + 8)) & ((chtype)((((1U) << 8) - 1U)) << ((0) + 8))))), (0)) : (-1)));
}
...
{
	T((T_CALLED("standout()")));
	returnIntAttr((attr_t)(((0 != (const void *)((_nc_stdscr()))) ? ((_nc_stdscr())->_attrs = (attr_t)(((chtype)((1U)) << ((8) + 8))), (0)) : (-1))));
}
NCURSES_EXPORT(int) standend (void)
{
	T((T_CALLED("standend()")));
	returnIntAttr((attr_t)(((0 != (const void *)((_nc_stdscr()))) ? ((_nc_stdscr())->_attrs = (attr_t)((1U - 1U)), (0)) : (-1))));
}
