...
$(TARGET)/main_interactive : $(SRC)/main_interactive.c $(SRC)/core/breakpoints.c $(SRC)/core/symbols.c $(SRC)/core/disasm.c $(SRC)/core/dwarf.c $(SRC)/core/watchpoints.c $(SRC)/display/output.c $(SRC)/display/sections.c $(SRC)/display/theme.c $(SRC)/cli/config.c $(SRC)/cli/parser.c $(SRC)/cli/readline.c
	gcc -Wall -Wextra -g -DHAVE_LIBUNWIND -I$(SRC) -I$(SRC)/core -I$(SRC)/display -I$(SRC)/cli $(SRC)/main_interactive.c $(SRC)/core/breakpoints.c $(SRC)/core/symbols.c $(SRC)/core/disasm.c $(SRC)/core/dwarf.c $(SRC)/core/watchpoints.c $(SRC)/display/output.c $(SRC)/display/sections.c $(SRC)/display/theme.c $(SRC)/cli/config.c $(SRC)/cli/parser.c $(SRC)/cli/readline.c -o $@ -ldwarf -lunwind -lunwind-ptrace -lunwind-generic -lreadline
